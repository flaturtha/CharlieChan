 ...
 */
 gulp.task('watch', function() {
  gulp.watch('_assets/**/*.scss', ['sass']);
   gulp.watch(['*.html', '*.xml', '*.json', '_includes/*', '_layouts/*.html', '_pages/**/*', '_posts/*', '_short-stories/*', '_novelettes/*', '_novellas/*', '_novels/*', '_the-red-file/*', '_murderwiki/*', '_downloads/*', '_landingpages/*', '_emails/*', '_serials/**/*'], ['jekyll-rebuild']);
});
