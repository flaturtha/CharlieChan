 ...
 */
 gulp.task('watch', function() {
  ...
  gulp.watch(['*.html', '*.xml', '_includes/*', '_layouts/*.html', '_pages/**/*', '_posts/*', '_short-stories/*', '_novellas/*', '_novels/*', '_the-red-file/*', '_murderwiki/*', '_downloads/*', '_landingpages/*'], ['jekyll-rebuild']);
});
