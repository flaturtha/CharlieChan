---
layout: default2
permalink: /subscriptions/thank-you-for-subscribing/
...
<div class="{{ page.title }}">
  ...
  <section class="page-intro">
    <div class="trf__main">
      <p class="intro">Thanks for subscribing to the Tales of Murder <span class="italics">CaseFiles</span>, the free weekly email digest of new stories and subscriber-only specials.</p>

      <p>As promised, you can download your copy of the thrilling novella THE CAMPAIGN FOR VENGEANCE below.</p>
